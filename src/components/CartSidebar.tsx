...
const CartSidebar: React.FC<CartSidebarProps> = ({ isAdminRoute = false, isKitchenRoute = false }) => {
  // Don't render cart sidebar content for admin or kitchen routes
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-[#E6D5B8] bg-[#FFF0DE]">
              <h2 className="text-xl text-[#783838] uppercase font-instrument font-normal tracking-wide">Shopping Bag</h2>
              <button
                onClick={toggleCart}
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-[#FFFDF7]">
              {cartItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <h3 className="text-lg text-[#783838] uppercase font-instrument font-normal tracking-wide mb-2">Your Bag is Empty</h3>
                  ...
                  <button
                    ...
                    className="w-full bg-[#8B2131] hover:bg-[#701a26] text-white py-3 uppercase tracking-widest text-sm font-normal"
                  >
                    Start Shopping
                  </button>
                </div>
                  ...
                  {cartItems.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        <div>
                          <h4 className="text-base text-[#783838] uppercase font-instrument font-normal tracking-wide line-clamp-2 leading-tight">
                            {item.name}
                          </h4>
            ...
            {cartItems.length > 0 && (
              <div className="border-t border-[#E6D5B8] bg-[#FFF8F0] p-6 space-y-4 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-[#2C1810] text-xl pt-2 border-t border-[#E6D5B8]">
                    <span className="text-[#783838] uppercase font-instrument font-normal tracking-wide">Total</span>
                    <span className="text-[#783838] font-bold">{formatCurrency(total, settings.currency_symbol)}</span>
                  </div>
