...
const defaultSettings: AppSettings = {
  ...
  cod_charge: 0,
  cod_threshold: 10000, // Default high limit for safety
  ...
  currency_symbol: '₹',
  cod_enabled: true,
  razorpay_enabled: true, // Enable by default for UI visibility
  upi_enabled: false,
  card_enabled: false,
...
export const useSettings = () => {
  ...
  const fetchSettings = async () => {
    try {
      ...
      // Fallback to default settings silently to avoid blocking the UI
