...
const Contact = () => {
  ...
  const contactInfo = {
    ...
    storeName: settings?.store_name || 'Jabbrr Afghani',
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground">
          Have questions about our menu? We'd love to hear from you. Send us a message and we'll respond as soon as possible.
        </p>
      </div>
