...
const BestSellers = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-background relative overflow-hidden">
      {/* Background accent - Jabbrr Afghani Theme */}
      <div className="absolute top-0 left-0 w-full h-full bg-background -z-10"></div>

      <div className="max-w-[1600px] mx-auto px-6 relative z-10">
        {/* Header Area */}
        <div className="flex flex-col items-center justify-center text-center mb-8 gap-4 pb-4 border-b border-border relative">
          <div>
            <span className="text-[10px] uppercase tracking-[0.25em] text-primary mb-2 block font-medium font-orange-avenue">SHOP THE ICONS</span>
        ...
        >
          {loading ? (
            ...
            <div className="text-center py-20 border border-border p-8">
              ...
              <h3 className="text-xl font-orange-avenue font-normal text-foreground mb-2">No bestsellers available</h3>
              <p className="text-muted-foreground font-light">Check back later for our top-selling items.</p>
            </div>
          )}
        </div>
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="group inline-flex items-center gap-3 bg-primary text-white px-10 py-4 text-xs font-orange-avenue font-normal uppercase tracking-[0.2em] hover:bg-primary/90 transition-all duration-300"
          >
