...
const NewArrivals = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary/10 rounded-full filter blur-[100px] opacity-60 pointer-events-none"></div>
      ...
      <div className="max-w-[1600px] mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-8 gap-4 border-b border-border pb-4 relative">
          <div>
            <span className="text-[10px] uppercase tracking-[0.25em] text-primary mb-2 block font-medium">FRESH FROM KITCHEN</span>
        ...
        >
          {loading ? (
            ...
            <div className="text-center py-20 border border-border p-8">
              ...
              <h3 className="text-xl font-orange-avenue font-normal text-foreground mb-2">No new arrivals yet</h3>
              <p className="text-muted-foreground font-light">Check back soon for latest additions.</p>
            </div>
          )}
        </div>
