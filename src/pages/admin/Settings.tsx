            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full md:w-1/2 px-3 py-2 border border-input rounded-md text-sm bg-background text-foreground"
                >
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 border rounded-lg bg-muted/50">
                <h3 className="font-medium mb-2 text-muted-foreground">Google Maps API - Removed</h3>
